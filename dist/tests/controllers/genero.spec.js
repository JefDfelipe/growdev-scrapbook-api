...
const _2_1 = __importDefault(require("../../controllers/2"));
const services_1 = require("../../services");
const repositories_1 = require("../../database/repositories");
jest.mock('../../src/database/repositories/genero.ts');
jest.mock('../../src/database/repositories');
// SUT -> system under test
const makeSut = () => new _2_1.default(new services_1.UserService(), new repositories_1.CacheRepository());
describe('Genero Controller', () => {
    ...
    describe('Index (List)', () => {
        it('should return ...', async () => {
            ...
            jest.spyOn(services_1.UserService.prototype, 'find')
        ...
        it('should call CacheRepository...', async () => {
            ...
            jest.spyOn(services_1.UserService.prototype, 'find').mockResolvedValue(dto.map(item => ({ ...item, id: 1 })));
            const getSpy = jest.spyOn(repositories_1.CacheRepository.prototype, 'find').mockResolvedValue(null);
            const setSpy = jest.spyOn(repositories_1.CacheRepository.prototype, 'save');
            const request = {};
            const response = {
                json: jest.fn().mockResolvedValue(dto),
                status: jest.fn()
